...
class Model(nn.Module):
    def __init__(self, cfg='yolov5e.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='v5Lite-e-Pconv.yaml', help='model.yaml')
